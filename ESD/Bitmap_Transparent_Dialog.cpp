...
CBitmap_Transparent_Dialog::CBitmap_Transparent_Dialog()
{
    m_hBitmap = NULL;
...
BEGIN_MESSAGE_MAP(CBitmap_Transparent_Dialog, CStatic)
    //{{AFX_MSG_MAP(CBitmap_Transparent_Dialog)
    ON_WM_ERASEBKGND()
...
/////////////////////////////////////////////////////////////////////////////
// CBitmap_Transparent_Dialog message handlers

BOOL CBitmap_Transparent_Dialog::SetBitmap(HBITMAP hBitmap)
{
...
BOOL CBitmap_Transparent_Dialog::SetBitmap(UINT nIDResource)
{
    ...
    return CBitmap_Transparent_Dialog::SetBitmap(hBmp);
}

BOOL CBitmap_Transparent_Dialog::SetBitmap(LPCTSTR lpszResourceName)
{
    m_nResourceID = -1;
...
BOOL CBitmap_Transparent_Dialog::ReloadBitmap()
{
    if (m_nResourceID > 0) 
...
void CBitmap_Transparent_Dialog::PreSubclassWindow() 
{
    CStatic::PreSubclassWindow();
    ModifyStyle(0, SS_OWNERDRAW);
}

BOOL CBitmap_Transparent_Dialog::OnEraseBkgnd(CDC* pDC) 
{
    CRect rect;
    GetClientRect(rect);
...
void CBitmap_Transparent_Dialog::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
...
// Suggested by
void CBitmap_Transparent_Dialog::OnSysColorChange() 
{
