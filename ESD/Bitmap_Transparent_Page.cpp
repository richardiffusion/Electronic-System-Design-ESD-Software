...
/////////////////////////////////////////////////////////////////////////////
// CBitmap_Transparent_Page

CBitmap_Transparent_Page::CBitmap_Transparent_Page()
{
    m_hBitmap = NULL;
...
BEGIN_MESSAGE_MAP(CBitmap_Transparent_Page, CStatic)
    //{{AFX_MSG_MAP(CBitmap_Transparent_Page)
    ON_WM_ERASEBKGND()
...
/////////////////////////////////////////////////////////////////////////////
// CBitmap_Transparent_Page message handlers

BOOL CBitmap_Transparent_Page::SetBitmap(HBITMAP hBitmap)
{
...
BOOL CBitmap_Transparent_Page::SetBitmap(UINT nIDResource)
{
    ...
    return CBitmap_Transparent_Page::SetBitmap(hBmp);
}

BOOL CBitmap_Transparent_Page::SetBitmap(LPCTSTR lpszResourceName)
{
    m_nResourceID = -1;
...
BOOL CBitmap_Transparent_Page::ReloadBitmap()
{
    if (m_nResourceID > 0) 
...
void CBitmap_Transparent_Page::PreSubclassWindow() 
{
    CStatic::PreSubclassWindow();
    ModifyStyle(0, SS_OWNERDRAW);
}

BOOL CBitmap_Transparent_Page::OnEraseBkgnd(CDC* pDC) 
{
    CRect rect;
    GetClientRect(rect);
...
void CBitmap_Transparent_Page::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
...
// Suggested by
void CBitmap_Transparent_Page::OnSysColorChange() 
{
